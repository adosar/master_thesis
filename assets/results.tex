...
the 12 feature maps of \conv{1} layer. In contrast, the feature maps of the
...
\conv{2}) emphasize the texture of the structure. For instance, the 3rd
...
\parencite{Cao2023, Bucior2019} \emph{and crystal graphs}\index{Crystal graphs}
...
\emph{\textbf{Point clouds}} \parencite{Qi2016, Bello2020} are a natural way to
solve this problem, since they are just \emph{a set of
