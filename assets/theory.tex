...
to take advantage of the experience (aka \emph{data}\index{Data}), it must be written
...
\emph{training phase}, \gls{ml} approaches are divided into three main
\emph{learning paradigms}\index{Learning paradigms}: \emph{\textbf{unsupervised
learning}\index{Learning paradigms!Unsupervised learning}, \textbf{supervised
learning}\index{Learning paradigms!Supervised learning} and
\textbf{reinforcement learning}\index{Learning paradigms!Reinforcement
learning}}. The following definitions are not by any means formal, but merely
serve as an intuitive description of the different paradigms.
...
Gebauer2022}. This is one approach of how \gls{ml} can solve the \emph{inverse
design problem}\index{Inverse design}.
...
%\end{figure}
%%
%%Drawing overfitting and underfitting with \LaTeX:
%%
%%\begin{figure}
%%	\centering
%%	\includesvg{image}
