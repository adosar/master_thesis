...
For instance, a computer program\index{Spam filter} that
...
\end{equation}
combining \emph{mean squared loss}\index{Mean squared error} and
\emph{Lasso regularization}\index{Lasso} as training loss:
\begin{equation}
	\label{eq:lasso}
