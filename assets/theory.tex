...
\begin{figure}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\begin{tikzpicture}
			...
			\begin{axis}[
					%legend style={fill opacity=0.8, draw opacity=1, text opacity=1},
					xlabel=$x_{\phantom{1}}$, ylabel=$y$, title=Regression, domain=-2:2,
...
\subsection{Complexity, experience and performance}
