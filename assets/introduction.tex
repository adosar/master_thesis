...
\emph{input-output}\index{Input}\index{Output} pair, i.e. a mathematical
...
\emph{model}\index{Model}, which can be \emph{used to sort a large catalog of
...
used descriptors, are the so called \emph{geometric}\index{Geometric
descriptors} ones, which capture the pore environment of the framework. This
type of descriptors includes \gls{mof} characteristics such as void
fraction\index{Void fraction}, gravimetric surface area\index{Gravimetric
surface area} and pore limiting diameter\index{Pore limiting diameter}. Although
